...
import { Home, User, Code, Briefcase, MessageSquare, GraduationCap, Award, TrendingUp, Mail, Linkedin, Github, Phone, Zap, PenLine } from 'lucide-react'
...
const navItems: { key: Section; label: string; icon: React.ElementType }[] = [
  ...
  { key: 'articles', label: 'Articles', icon: PenLine },
