        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              transition={{ duration: 0.2 }}
              className="bg-card-bg border border-card-border shadow-2xl overflow-hidden rounded-2xl rounded-br-none w-[calc(100vw-135px)] sm:w-[440px] lg:w-[550px] max-w-[600px] mr-1"
              style={{
            ...
            >
              ...
              {/* Messages */}
              <div className="overflow-y-auto p-2 lg:p-4 space-y-2 lg:space-y-4 h-80 lg:h-[525px] flex-1">
                {messages.length === 0 && (
